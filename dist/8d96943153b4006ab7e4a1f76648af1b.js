...
console.log(circle_1.calcCirc(12));
console.log(rectangle_1.calcRect(1.5, 5));
utils_1.sepline();
//# sourceMappingURL=index.js.map
},{"./utils":3,"./circle":4,"./rectangle":5}],0:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://' + window.location.hostname + ':58285/');
